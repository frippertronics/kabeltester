#ifndef HOST_AVR_IOXXX_H
#define HOST_AVR_IOXXX_H

#include <stdint.h>

// The test is for the ATmega2560 which is ATmegaxx0
#define __ATmegaxx0__

/* This is very hacky but these functions will _always_ 
 * be mocked away and should _never_ be run.
 */
uint8_t sfr_table[255] = {0x00U};

/* Defines for host compatibility to compensate for AVR-GCC ones*/
#define _VECTOR(val) (__vector ##val)
#define _SFR_IO8(val) (sfr_table[val])
#define _SFR_MEM8(val) (sfr_table[val])
#define _SFR_MEM16(val) (sfr_table[val])
